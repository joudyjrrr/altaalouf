...
const FinancialReportSection = ({ data, className }) => {
  return (
    <div
      className={`mt-16 grid grid-cols-4 max-md:grid-cols-2 max-sm:grid-cols-1 
      gap-6 px-32 py-8 justify-center mx-auto ${className}`}
    >
      {data.map((d, idx) => (
        <div
          key={idx}
          ...
          <div className="w-[200px] h-[200px] overflow-hidden rounded-xl relative">
            ...
            <div
              className={`flex  text-secondary text-4xl w-full justify-center
                 items-center font-bold absolute  top-[35%] ${
