...
import { location1, location2, location3, Testimonials, Testimonials1, gold_star, coma, arrowLeft, arrowRight } from "../../../public/images"
...
const data = [
    {
        img: location1, title: "United Arab Emirates"
    },
    {
        img: location2, title: "London"
    },
    {
        img: location3, title: "Lebanon"
    },
    {
        img: location3, title: "Lebanon"
    },
    ...
    return (
        <div className='bg-[#030613] h-full Testimonials    '>
            <div className='w-full h-full'>
                <Title title1={`Representative`} title2={`Location`} title2Color={`white`} />
                <Swiper
                    modules={[Autoplay]}
                    spaceBetween={10}
                    slidesPerView={3}
            ...
            <div className='flex justify-between w-full items-center pe-16 h-[200px]'>
                ...
                <div className='w-full flex justify-end items-center h-full pt-12'>
                    <Button className="button-border w-fit !rounded-lg text-lg">View More</Button>
                </div>
            </div>
            <div className='relative '>
                <div className=" flex justify-center items-center gap-32 mt-6 absolute end-0 bottom-[10%] z-[2000]">
                    ...
                    <div style={{
                        top: "10px !important"
                    }} className="custom-pagination3   flex justify-center gap-2 !top-0 absolute z-[1000000000000]"></div>
                    <button
                ...
                >
                    {dataTestimonials.map((d, index) => (
                        <SwiperSlide key={index} className="!w-[65%] ">
                                    ...
                                    <div className='flex justify-between items-center'>
                                        <div className='flex gap-8'>
                                            ...
                                            <div className='flex flex-col text-white justify-center'>
                                                <h1 className='text-3xl font-semibold'>Hashim Al-Sakkal</h1>
                                                <div className='flex gap-1'>
                                                    {[...Array(5)].map((_, i) => (
                                                        <Image key={i} src={gold_star} alt='' width={25} height={25} />
                                                    ))}
                                                </div>
                                            </div>
                                        </div>
                                        <p className='text-secondary text-xl font-medium'>2021-05-05</p>
                                    </div>
                                    <div className='flex items-start gap-8'>
                                        <Image src={coma} alt='' width={80} height={80} />
                                        <div className='flex flex-col gap-1 text-white text-xl'>
                                            <p>From my experience with INZO, I've opened more than one</p>
                                            <p>account with different brokers, but finally, I found this</p>
