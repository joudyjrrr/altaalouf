...
const AwardSection = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0F2147]  via-[#0F2147] via-80%
     to-white  relative   mt-16  ">
        ...
        <div className="grid grid-cols-4 gap-4 mt-24 p-4">
          {cards.map((d, idx) => (
            ...
            >
              ...
              <div className="bg-awarc_card_back py-8 text-center absolute 
              rounded-b-xl bottom-[1px] h-[28%] end-[-3px] w-full z-[10000]">
      ...
      <div
        className="relative z-[1000] bg-star_background   text-white mt-16"
        style={{ clipPath: "ellipse(75% 50% at 50% 50%)" }}
      >
        <div className="relative w-full bg-transparent flex 
        justify-center items-center text-center pt-8">
          <Image
            src={Explore}
            width={200}
            height={50}
        ...
        <div className="flex px-[15rem] pt-10 justify-between">
          ...
          <div className="flex flex-col items-center  pt-[8rem]">
            ...
            <div className="relative w-[350px] h-[300px]">
              ...
              <div className="absolute top-[25%] right-[-10px] flex flex-col
               items-center justify-center w-28 h-28 ">
                <Image src={ios} alt="" />
              </div>
              <div className="absolute bottom-[7rem] left-
              [1rem] flex flex-col items-center justify-center w-28 h-28 ">
                <Image src={windows} alt="" />
              </div>
              <div className="absolute bottom-12 right-[30%] flex
