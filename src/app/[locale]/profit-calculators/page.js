...
const cols = [
    ...
    },
    {
        ...
        selector: (row) => (
            <span >
                <span className='bg-[#1A2A48] p-2 rounded-lg mx-2'>{row.sub_name}</span> {row.name}
            </span>
        ),
    },
    {
        ...
        <div className="w-full h-full bg-primary pb-20 relative">
            <div className="w-full pt-[13rem] bg-ourTeamBg   bg-cover bg-top bg-no-repeat  z-[100]">
                <div className='w-full text-center text-white flex flex-col justify-center items-center'>
                    ...
                    <p className='mt-4'>Calculate potential gains, set precise profit targets, and manage losses before trading.</p>
                    <div className='w-[70%] mt-8 relative '>
                        ...
                        <div className='w-[100%] mx-auto rounded-md bg-primary mt-4 z-[100] relative shadow-md'>
                            <div className='grid p-8 grid-cols-2 gap-12'>
                                ...
                                <Input label={`Open Price`} icon={qusation} classNameParent={`w-full`} />
                                <Input label={`Close Price`} icon={qusation} classNameParent={`w-full`} />
                                <Input label={`Trade Size (lots)`} icon={qusation} classNameParent={`w-full`} />
                                <Input label={`Deposit Currency`} icon={qusation} classNameParent={`w-full`} />
                            ...
                            <div className='bg-[#0C1B3C] w-[90%] rounded-md mx-auto h-[200px]  flex justify-center items-center text-center'>
                                <h1 className='text-[#FFFFFF] opacity-50 text-7xl font-bold'>$ 00.00</h1>
                            </div>
