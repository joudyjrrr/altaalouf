...
const cols = [
  ...
  },
  {
    ...
    selector: (row) => <span>{row.quote}</span>,
  },
  {
  ...
  {
    name: "Markup Bid",
    selector: (row) => <span>{row.bid}</span>,
  },
  {
    name: "Markup Ask",
    selector: (row) => <span>{row.ask}</span>,
  },
  {
    name: "Spread Min",
    selector: (row) => <span>{row.spread}</span>,
  },
  {
    name: "Sunday Open GMT+2",
    selector: (row) => <span>{row.open}</span>,
  },
  {
    name: "Friday Close GMT+2",
    selector: (row) => <span>{row.close}</span>,
  },
];
const page = () => {
  return (
