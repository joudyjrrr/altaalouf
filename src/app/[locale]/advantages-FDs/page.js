        ...
        <div className="w-full h-full bg-primary">
            <div className="w-full pt-56 pb-24  bg-Education_Bg  bg-cover bg-center bg-no-repeat z-[100]">
                <div className="w-full  relative  text-center h-full flex justify-start items-center gap-8 flex-col">
                    ...
                    <h2 className="text-white text-xl">
                        IC Markets Global offers flexible trading conditions across a broad range of CFDs covering Indices, Energies, Metals, < br />
            ...
            <div className="text-center w-full px-16 pt-8">
                <h1 className="text-[#038BD3] text-2xl font-bold leading-10">
                    CFD stands for ‘Contract for Difference’ and is a contract between two parties < br /> agreeing to exchange the difference in the value of a security,
                    instrument, or other <br /> asset between the time at which the CFD is opened and the time at which it is closed.
                </h1>
            </div>
            <div className="text-center w-full px-4 pt-8">
                <h1 className="text-white text-[18px]  leading-10">
                    CFDs are extremely versatile products growing in popularity as a short term investment tool. They provide an efficient way <br /> of maximizing your capital outlay and can help diversify
                    your existing investment portfolio or hedge a position. Some of <br /> the advantages of trading CFDs are listed below.
                </h1>
            </div>
